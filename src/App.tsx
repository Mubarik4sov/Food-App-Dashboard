...
function App() {
  ...
  const orderStats = [
    ...
    { title: 'Confirmed', value: 26, icon: CheckCircle, color: 'green' as const },
    { title: 'Processing', value: 6, icon: Package, color: 'blue' as const },
    { title: 'Out for delivery', value: 7, icon: Truck, color: 'purple' as const },
  ];

  const additionalStats = [
    { title: 'Delivered', value: 46, icon: CheckCircle, color: 'green' as const },
    { title: 'Cancelled', value: 3, icon: XCircle, color: 'red' as const },
    { title: 'Returned', value: 2, icon: RotateCcw, color: 'gray' as const },
    { title: 'Failed to Deliver', value: 3, icon: AlertTriangle, color: 'red' as const },
  ];
  ...
  const topProducts = [
    { name: 'Italian Spicy Pizza', price: 'USD 45', rating: 4.5, orders: 120, image: 'https://images.pexels.com/photos/315755/pexels-photo-315755.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' },
    { name: 'Ice Cream', price: 'USD 15', rating: 4.2, orders: 85, image: 'https://images.pexels.com/photos/1352278/pexels-photo-1352278.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' },
    { name: 'Popcorn Rice Bowl', price: 'USD 25', rating: 4.8, orders: 95, image: 'https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' },
    { name: 'Ginger & Figs', price: 'USD 35', rating: 4.3, orders: 78, image: 'https://images.pexels.com/photos/1099680/pexels-photo-1099680.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' },
  ];

  const mostRatedProducts = [
    { name: 'Beef Mince 2', price: 'USD 25', rating: 4.9, orders: 150, image: 'https://images.pexels.com/photos/361184/asparagus-steak-veal-steak-veal-361184.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' },
    { name: 'Mozzarella Cheese', price: 'USD 18', rating: 4.7, orders: 120, image: 'https://images.pexels.com/photos/1070850/pexels-photo-1070850.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' },
    { name: 'Chicken Sandwich W', price: 'USD 22', rating: 4.6, orders: 98, image: 'https://images.pexels.com/photos/1633525/pexels-photo-1633525.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' },
    { name: 'Spicy Burger', price: 'USD 28', rating: 4.5, orders: 110, image: 'https://images.pexels.com/photos/1556909/pexels-photo-1556909.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' },
  ];
  ...
  const recentOrders = [
    { id: '100164', customer: 'Processing', status: 'processing' as const, time: '2 mins ago', amount: 'USD 45' },
    { id: '100163', customer: 'Confirmed', status: 'confirmed' as const, time: '5 mins ago', amount: 'USD 32' },
    { id: '100162', customer: 'Delivered', status: 'delivered' as const, time: '10 mins ago', amount: 'USD 78' },
    { id: '100161', customer: 'Cancelled', status: 'cancelled' as const, time: '15 mins ago', amount: 'USD 25' },
    { id: '100160', customer: 'Pending', status: 'pending' as const, time: '20 mins ago', amount: 'USD 55' },
  ];
    ...
    switch (activeSection) {
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-xl text-white p-6 lg:p-8">
              ...
              <p className="text-red-100">Monitor your business analytics and manage your food delivery operations</p>
            </div>

            {/* Business Analytics */}
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="text-xl lg:text-2xl font-semibold text-gray-800 mb-6">Business Analytics</h2>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
              ...
              <Chart title="Earnings Statistics" data={earningsChartData} type="bar" color="rgb(34, 197, 94)" />
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-xl border border-gray-200">
                <div className="p-6 border-b border-gray-200">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold text-gray-800">Most Rated Products</h3>
                    <button className="text-sm text-red-600 hover:text-red-700 font-medium">
                      View All
                    </button>
                  </div>
      ...
      case 'delivery-man-list':
        if (showAddDeliveryman) {
          return <AddDeliverymanPage onBack={() => setShowAddDeliveryman(false)} />;
        }
        return <DeliverymanListPage />;

      case 'add-new-delivery-man':
        return <AddDeliverymanPage onBack={() => setActiveSection('delivery-man-list')} />;
